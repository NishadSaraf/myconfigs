...
" Show all characters that aren't whitespace. So spaces are the only thing that doesn't show up.
set showbreak=↪\ 
...
if has("autocmd")
    autocmd BufWritePre *.cc,*.c,*.h,*.cpp,*.txt,*.js,*.py,*.wiki,*.sh,*.coffee :call CleanExtraSpaces()
endif
